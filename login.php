...
<body class="bg-gradient-primary">
 ...
 <h3 align="center" style="margin-top:4%;color:#fff ;font-family:copperplate;font-size:3em"><b>Admin Login</b></h3>
...
<form name="login" method="post">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" id="lgn_img">
                            <img src="img/d_4.jpg"  width="460em" height="430em">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
