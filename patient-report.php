...
?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800" style="margin-top:3rem">Search Result Againt '<?php echo $searchdata;?>' </h1>
...
where ( tblpatients.MobileNumber like '%$searchdata%' || tbltestrecord.OrderNumber like '%$searchdata%')
    ");
$cnt=1;
